...
REVOKE ALL ON FUNCTION public.workspace_membership_meets(uuid, text[]) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.workspace_membership_meets(uuid, text[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.workspace_membership_meets(uuid, text[]) TO service_role;

COMMENT ON FUNCTION public.workspace_membership_meets IS
