...
export const addClientTool: FunctionDeclaration = {
  ...
  parameters: {
    type: Type.OBJECT,
    description: "Pridėti naują klientą į sistemą. Galiu AUTOMATIŠKAI rasti adresą jei žinote miestą ir vietos pavadinimą! Visi laukai nebūtini - svarbu išsaugoti klientą.",
    properties: {
...
export const geocodeAddressTool: FunctionDeclaration = {
  ...
  parameters: {
    type: Type.OBJECT,
    description: "Rasti adreso koordinates (GPS) naudojant miestą ir vietos pavadinimą. Naudinga kai žinote tik miestą ir parduotuvės/pavadinimą.",
    properties: {
      city: { type: Type.STRING, description: "Miestas (pvz. Klaipėda, Rietavas)" },
      placeName: { type: Type.STRING, description: "Vietos pavadinimas (pvz. Tūzas, Maxima, Vatušių gatvė)" },
...
export const addOrderTool: FunctionDeclaration = {
  ...
  parameters: {
    type: Type.OBJECT,
    description: "Sukurti naują užsakymą klientui. Visi laukai NEPRIVALOMI - svarbu išsaugoti užsakymą! Galiu AUTOMATIŠKAI rasti adreso koordinates jei žinote miestą ir vietos pavadinimą!",
    properties: {
      clientName: { type: Type.STRING, description: "Kliento vardas (iš esamų klientų sąrašo)" },
      address: { type: Type.STRING, description: "Valymo adresas (jei žinote tik miestą + vietą, bus rasta automatiškai)" },
...
export const addExpenseTool: FunctionDeclaration = {
  ...
  parameters: {
    type: Type.OBJECT,
    description: "Užregistruoti verslo išlaidas. Visi laukai NEPRIVALOMI - svarbu išsaugoti išlaidą!",
    properties: {
      title: { type: Type.STRING, description: "Išlaidų pavadinimas (pvz. Kuras)" },
      amount: { type: Type.NUMBER, description: "Suma eurais" },
      date: { type: Type.STRING, description: "Data (YYYY-MM-DD)" },
      category: { type: Type.STRING, enum: ["kuras", "priemonės", "reklama", "kita"], description: "Kategori" },
...
export const updateOrderTool: FunctionDeclaration = {
  ...
  parameters: {
    type: Type.OBJECT,
    description: "Atnaujinti esamą užsakymą. Visi laukai NEPRIVALOMI - svarbu išsaugoti pakeitimus!",
    properties: {
