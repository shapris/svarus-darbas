    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      ...
      >
        ...
        <p className="text-slate-600 text-sm leading-relaxed mb-4">
          Ši CRM versija skirta darbui su debesimi. Sukonfigūruokite <strong>Supabase</strong>{' '}
          aplinkos kintamuosius pagal repo{' '}
        ...
        <ul className="text-sm text-slate-600 space-y-2 list-disc pl-5 mb-4">
          <li>
            ...
            <code className="text-xs bg-slate-100 px-1 rounded">package.json</code> (projekto
            šaknyje).
          </li>
          <li>
            ...
            <code className="text-xs bg-slate-100 px-1 rounded">VITE_SUPABASE_ANON_KEY</code>. Ne
            tik <code className="text-xs bg-slate-100 px-1 rounded">SUPABASE_URL</code> — naršyklė
            jo nemato.
          </li>
          <li>
            Išjunkite{' '}
            <code className="text-xs bg-slate-100 px-1 rounded">VITE_ALLOW_OFFLINE_CRM</code> ir{' '}
            <code className="text-xs bg-slate-100 px-1 rounded">VITE_DEMO_MODE</code>, jei norite
            tikros debesies.
          </li>
          <li>
            Po kiekvieno <code className="text-xs bg-slate-100 px-1 rounded">.env</code> pakeitimo:{' '}
            <strong>sustabdykite</strong> terminalą (
            <kbd className="px-1 bg-slate-100 rounded">Ctrl+C</kbd>) ir vėl paleiskite{' '}
